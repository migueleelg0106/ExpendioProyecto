 ...
 * @author uriel
 */
public class ReporteProductoMenosVendidoDAO {
    public static ArrayList<ReporteProductoVendido> obtenerProductosMenosVendidos() throws SQLException {
        ArrayList<ReporteProductoVendido> productos = new ArrayList<>();
        String query = "SELECT nombre, total_vendido FROM vista_producto_menos_vendido";
